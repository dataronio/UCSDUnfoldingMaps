...
public class EarthquakeCityMap extends PApplet {
	...
	private void selectMarkerIfHover(List<Marker> markers)
	{
		...
		for (Marker mark : markers) {
			CommonMarker m = (CommonMarker) mark; // cast firt to CommonMarker
	...
	public void mouseClicked()
	{
		if (lastClicked != null) {
			...
			checkClickCitiesMarkers();
			if (lastClicked == null) {
				checkClickQuakesMarkers();
			}
		}
	}
	
	private void checkClickCitiesMarkers() {
		// now loop thru cities for a click and set accordingly
		for (Marker mark : cityMarkers) {
			if (!(mark.isHidden()) && mark.isInside(map, mouseX, mouseY)) {
				...
				for (Marker q : quakeMarkers) {
					...
					if (quake.getDistanceTo(mark.getLocation()) > quake.threatCircle()) {
	...
	private void checkClickQuakesMarkers() {
