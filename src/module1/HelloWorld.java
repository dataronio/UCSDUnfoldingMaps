...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		this.background(153, 255, 102);
		
		// Select a map provider
		AbstractMapProvider provider = new Google.GoogleTerrainProvider();
		AbstractMapProvider providerSimple = new Google.GoogleSimplifiedProvider();
		// Set a zoom level
		int zoomLevel = 10;
		...
		map2 = new UnfoldingMap(this, 420, 50, 350, 500, providerSimple);
        
		map2.zoomAndPanTo(zoomLevel, new Location(45.4, -122.7));
