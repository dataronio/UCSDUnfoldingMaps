...
public class EarthquakeCityMap extends PApplet {
	...
	private void printQuakes() 
	{
		...
		for (Marker country : countryMarkers) {
			...
			numLandQuakes += numCountryQuakes; // add number of quakes in country to our running total of landquakes
			if (numCountryQuakes > 0) {
			System.out.println(country.getProperty("name").toString() + "  " + numCountryQuakes );
			}
		}
		numOceanQuakes = (quakeMarkers.size() - numLandQuakes);
